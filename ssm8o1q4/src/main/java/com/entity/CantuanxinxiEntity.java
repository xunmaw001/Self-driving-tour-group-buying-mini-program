 ...
 */
@TableName("cantuanxinxi")
public class CantuanxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public CantuanxinxiEntity() {
		
	}
	
	public CantuanxinxiEntity(T t) {
		try {
	 ...
	 * 设置：参团时间
	 */
	public void setCantuanshijian(Date cantuanshijian) {
		this.cantuanshijian = cantuanshijian;
	}
	/**
	 * 获取：参团时间
	 */
	public Date getCantuanshijian() {
