<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">自驾游拼团小程序的设计与实现注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='faqiren'" class="input-group">
			   <div class="label">发起账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.faqizhanghao" class="input" type="text" placeholder="发起账号">
			   </div>
			 </div> -->
			<el-form-item label="发起账号" class="input" v-if="tableName=='faqiren'">
			  <el-input v-model="ruleForm.faqizhanghao" autocomplete="off" placeholder="发起账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='faqiren'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='faqiren'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='faqiren'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='faqiren'" class="input-group">
			   <div class="label">发起姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.faqixingming" class="input" type="text" placeholder="发起姓名">
			   </div>
			 </div> -->
			<el-form-item label="发起姓名" class="input" v-if="tableName=='faqiren'">
			  <el-input v-model="ruleForm.faqixingming" autocomplete="off" placeholder="发起姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='faqiren'" class="input-group">
			   <div class="label">邮箱</div>
			   <div class="input-container">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='faqiren'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='faqiren'" class="input-group">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='faqiren'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `faqiren` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.faqixingming) && `faqiren` == this.tableName){
        this.$message.error(`发起姓名不能为空`);
        return
      }
