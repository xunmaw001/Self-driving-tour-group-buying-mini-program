<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开团时间" prop="kaituanshijian">
          <el-input v-model="ruleForm.kaituanshijian" 
              placeholder="开团时间" clearable  :readonly="ro.kaituanshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开团时间" prop="kaituanshijian">
              <el-input v-model="ruleForm.kaituanshijian" 
