<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="景点分类" prop="jingdianfenlei">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开发时间" prop="kaifashijian">
          <el-input v-model="ruleForm.kaifashijian" 
              placeholder="开发时间" clearable  :readonly="ro.kaifashijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开发时间" prop="kaifashijian">
              <el-input v-model="ruleForm.kaifashijian" 
                placeholder="开发时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="景点简介" prop="jingdianjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jingdianjianjie" label="景点简介" prop="jingdianjianjie">
                    <span>{{ruleForm.jingdianjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="景点详情" prop="jingdianxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jingdianxiangqing" label="景点详情" prop="jingdianxiangqing">
                    <span v-html="ruleForm.jingdianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingdianxiangqing = true;
          ...
          if(o=='kaifashijian'){
            this.ruleForm.kaifashijian = obj[o];
	    this.ro.kaifashijian = true;
            continue;
          }
          if(o=='menpiaojiage'){
	...
	this.ruleForm.jingdianxiangqing = this.ruleForm.jingdianxiangqing.replace(reg,'../../../ssm8o1q4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
